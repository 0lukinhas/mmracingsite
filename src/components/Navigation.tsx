            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-24">
                    ...
                    <div className="hidden md:flex items-center space-x-6 text-sm tracking-widest text-mm-muted">
                        ...
                        <a href="/mc177usa" className="text-mm-orange hover:text-white font-bold transition-colors flex items-center gap-1 border border-mm-orange/50 px-2.5 py-1 bg-mm-orange/10 hover:bg-mm-orange/20">
                            ★ USA TOUR #0177
                        </a>
                    </div>
            ...
            {isMobileMenuOpen && (
                ...
                >
                    <div className="px-2 pt-2 pb-6 space-y-4 flex flex-col items-center">
                        ...
                        <a href="/mc177usa" className="text-black bg-mm-orange font-bold block px-4 py-2 text-base tracking-widest uppercase w-[90%] text-center" onClick={() => setIsMobileMenuOpen(false)}>
